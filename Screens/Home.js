  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={styles.button2} onPress={() => this.props.navigation.navigate('MapaBlind')}><Text style={styles.textButton}>Mapa en modo ciego</Text></TouchableHighlight>
      </View>
    )
  }
}
