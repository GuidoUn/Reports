...
//toma la ubicacion
  _getLocationAsync = async () => {
    ...
    distanciaentreobs(){
      ...
      fetch(`http://10.10.32.52:3000/api/obstaculos?locationlat=${this.state.latitude}&locationlng=${this.state.longitude}`, {
  ...
  tomartodosobjs(){
    fetch(`http://10.10.32.52:3000/api/obstaculos/todos`, {
      ...
      />
        ...
        >
          ...
          {this.state.todoslosobs.map((coordinate, index) =>
            ...
            {!this.state.show && 
          <Animatable.View style={{     position: 'absolute',alignItems:'center',top: 40,
    marginLeft:150,}} animation={this.state.anim ? showAnimation : hideAnimation}>
